...
const script = defineComponent({
  ...
  setup(props, { emit, slots }) {
          ...
          [
            ...
            badgeValue
              ? createVNode(
                ...
                PATCH_FLAG.CLASS | PATCH_FLAG.TEXT
              )
              : createCommentVNode('v-if_badge', true),
          ],
          PATCH_FLAG.NEED_PATCH | PATCH_FLAG.CLASS
        )
      })
    }
    ...
    const renderArrow = (type: 'left' | 'right') => {
      ...
      return createVNode('div', { onClick, class: classList }, null, PATCH_FLAG.NEED_PATCH | PATCH_FLAG.CLASS)
    }
