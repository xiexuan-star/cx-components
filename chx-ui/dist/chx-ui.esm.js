import { defineComponent, computed, createVNode as createVNode$1, createCommentVNode, ref as ref$1, onMounted as onMounted$1, onBeforeUnmount as onBeforeUnmount$1, watch as watch$1, nextTick as nextTick$1, openBlock, createBlock, Fragment as Fragment$1, resolveComponent, mergeProps as mergeProps$1, withCtx, createElementVNode, renderSlot, createTextVNode as createTextVNode$1, toDisplayString, pushScopeId, popScopeId, reactive as reactive$1, inject, watchEffect, resolveDirective, withDirectives, createElementBlock, createStaticVNode, setBlockTracking, unref as unref$1, render as render$5, onUnmounted as onUnmounted$1, normalizeClass as normalizeClass$1, normalizeStyle as normalizeStyle$1, renderList, provide } from 'vue';
...
var script$8 = defineComponent({
    ...
    setup: function (props, _a) {
        ...
        var renderDisabled = function () {
            return createVNode$1('i', { onClick: function (e) { return e.stopPropagation(); }, "class": 'cx_mask' });
        };
    ...
    setup: function (props, _a) {
        ...
        var renderItems = function () {
            return tabs.value.map(function (item) {
                ...
                if (badgeValue >= 100)
                    badgeValue = '99+';
                return createVNode$1('div', { onClick: function () { return clickHandle(item.id); }, "class": classList }, [
                    item.name,
                    badgeValue
        ...
        var renderArrow = function (type) {
            ...
            return createVNode$1('div', { onClick: onClick, "class": classList }, null, 512 /* NEED_PATCH */ | 2 /* CLASS */);
        };
        ...
        var showArrow = ref$1(isShowArrow());
        ...
        watch$1(function () { return tabs.value; }, function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, nextTick$1()];
                    case 1:
                        _a.sent();
                        showArrow.value = isShowArrow();
                        return [2 /*return*/];
...
var script$5 = defineComponent({
    ...
    setup: function (props, _a) {
        ...
        var dialogVisible = ref$1(false);
        var fullscreenRef = ref$1(false);
        // 取消按钮回调
...
const _hoisted_4$2 = /*#__PURE__*/ _withScopeId$1(() => /*#__PURE__*/createElementVNode("i", { class: "el-icon-full-screen" }, null, -1 /* HOISTED */));
...
var useCopy = function (props) {
    ...
    var paste = function (payload) {
        ...
        var rows = clone$1(clipboard.value).map(function (item) {
...
var map$1 = R.curry(function (cb, f) { return f.map(cb); });
R.curryN(2, function (arg, io) { return io.unsafePerformIO(arg); });
...
R.curryN(2, function (text, ele) { return ((ele.innerText = text), ele); });
R.curryN(2, function (classList, ele) {
    var _a;
...
setDisplay('none');
setDisplay('block');
R.curryN(2, function (child, parent) { return (parent.appendChild(child), parent); });
R.curryN(3, function (eventName, listener, ele) {
...
var FormConfigAdaptor$1 = /** @class */ (function () {
    ...
    FormConfigAdaptor.use = function (plugin) {
        ...
        var updateHooks = function (source, key) {
            // map::Maybe->a
            var MaybeMap = map$1(R.ifElse(R.is(Function), push(source), R.identity));
...
var useDynamicConfig = function (props, emit) {
    var columnProxy = ref$1([]);
    var dynamicColumn = ref$1([]);
    var loading = ref$1(false);
    ...
    if (isObject$1(props.dynamic)) {
        watch$1(function () { return props.dynamic; }, R.converge(forceUpdate, [R.T]), { deep: true, immediate: true });
    }
    else {
        watch$1(function () { return props.tableConfig.items; }, R.converge(forceUpdate, [R.F]), {
            deep: true,
            immediate: true
        });
    }
...
var useRadioConfig = function (emit) {
    var radioValue = ref$1(-1);
    watch$1(function () { return radioValue.value; }, function (val) {
...
var useSelectConfig = function (tableDataVisitor, emit) {
    ...
    watch$1(function () { return tableDataVisitor.sortedData.length; }, function () { return __awaiter(void 0, void 0, void 0, function () {
        var _a, _b;
    ...
    watch$1(function () { return selectConfig.selectItem; }, updateSelectConfig, { deep: true, immediate: false });
...
var CxConfigAdaptor$1 = /** @class */ (function () {
    function CxConfigAdaptor(config) {
        ...
        var configDuplicate = onInits.reduce(function (res, hook) { return (isFunction$1(hook) ? hook(res) : res); }, R.clone(config));
    ...
    CxConfigAdaptor.prototype.getColumn = function () {
        ...
        var columnDuplicate = onOutputs.reduce(function (res, hook) { return (isFunction$1(hook) ? hook(res) : res); }, R.clone(this.basicColumn));
...
var format = function (val) { return dayjs(val).format('YYYY-MM-DD'); };
var formatDate = R.ifElse(R.is(Array), R.map(format), format);
                ...
                (openBlock(),
                    createBlock('div', { "class": hoisted_1, style: { width: formatWidth(cellWidth.value) } }, [
                        ...
                        column.headSlot && (rootSlots === null || rootSlots === void 0 ? void 0 : rootSlots[column.headSlot])
                            ? createVNode$1(rootSlots === null || rootSlots === void 0 ? void 0 : rootSlots[column.headSlot], { column: column })
        ...
        return function () {
            return createVNode$1('div', { "class": hoisted_2, style: pick(style.value, hoisted_1) }, [
                createVNode$1('table', { style: pick(style.value, ['left']) }, [
                    (openBlock(),
                        createBlock(Fragment$1, null, layeredHeadItems.value.map(function (headers, index) {
                            return (openBlock(),
                                createBlock('tr', null, [
                                    (openBlock(true),
                                        createBlock(Fragment$1, null, headers.map(function (col) {
        ...
        createBlock(Fragment$1, null, [
            params.column.sumSlot
                ...
                : ((_a = params.column.control) === null || _a === void 0 ? void 0 : _a.type) === 'index' || (isString$1(params.column.sum) && params.column.sum !== 'add')
                    ? createTextVNode$1((_b = params.column.sum) !== null && _b !== void 0 ? _b : '总计')
                    : renderDefaultNode(params),
        ]));
};
...
var Cell = defineComponent({
    ...
    setup: function (props) {
        ...
        // 聚焦提交tdFocus事件
        watch$1(function () { return isActived.value; }, function () {
            if (isActived.value) {
        ...
        var directionOption = reactive$1({
            visible: false,
        ...
        watch$1(invalidContent, function (val) {
            directionOption.text = val;
        });
        watch$1(errorVisible, function (val) {
        ...
        watch$1(function () { return mergeSpan.value.rowspan; }, function (val, oldVal) {
            if (val === oldVal)
                return;
        ...
        // 当值发生改变时发送一个广播
        watch$1(function () { return props.rowData[props.column.prop]; }, function () {
        ...
        if (['search', 'select'].includes((_a = props.column.control) === null || _a === void 0 ? void 0 : _a.type) || props.column.slot) {
            ...
            watch$1(function () { return props.rowData[textKey_1]; }, function () {
        ...
        return function () {
            ...
            return createVNode$1('td', __assign(__assign(__assign({ key: key }, handles), mergeSpan.value), { style: tdStyle.value, colid: props.column._colid, "class": { actived: cellActived.value } }), [
                createVNode$1('div', {
                    "class": 'cx-table_cell',
...
var TableRow = defineComponent({
    ...
    setup: function (props, _a) {
        ...
        var radioValue = inject('radioValue', ref$1(-1));
        var CxTable = inject('CxTable');
        var isHover = ref$1(false);
        watchEffect(function () {
            isHover.value = props.rowid === CxTable.hoveringRowid;
        });
        var isActive = ref$1(false);
        watchEffect(function () {
            var _a, _b;
            isActive.value =
            ...
            return createVNode$1(TableRow, {
                ...
                "default": function () {
                    return (openBlock(true),
                        createBlock(Fragment$1, null, CxTable.flatColumns.map(function (col) { return (openBlock(),
                            createBlock(Fragment$1, null, [
                        ...
                        : (openBlock(true),
                            createBlock(Fragment$1, null, (function () {
                                ...
                                data.forEach(function (rowData, rowIndex) {
                                    ...
                                    if (rootProp.expand) {
                                        result.push(createVNode$1(Expand, { rowData: rowData, rowIndex: rowIndex + indexPrepend, fixed: props.fixed }, null, PATCH_FLAG.FULL_PROPS));
                                    }
                                });
                ...
                createBlock(Fragment$1, null, [
                    [
                        (openBlock(),
                            createBlock(Fragment$1, null, [
                                fixed !== 'bottom'
                                    ? createVNode$1(CxTableHead, { "class": classList.value, style: style.value, fixed: fixed }, null, PATCH_FLAG.FULL_PROPS | PATCH_FLAG.CLASS | PATCH_FLAG.STYLE)
                ...
                createBlock('div', hoisted_1, [
                    createVNode$1('table', hoisted_2, [
                        createVNode$1('tbody', null, [
                            createVNode$1('tr', null, [
                                createVNode$1('td', { rowspan: rowspan }, [
                                    (function () {
                                        setBlockTracking(-1);
                                        var node = createVNode$1(script$4);
                                        setBlockTracking(1);
                                        return node;
                                    })()
                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    case 0:
                                        ...
                                        getTotals = R.compose(getMaybeValue, map$1(R.objOf('totals')), map$1(R.map(R.prop('prop'))), map$1(R.filter(R.compose(truthy, R.prop('sum')))), map$1(R.prop('flatColumns')), Maybe.of);
...
var TeleFormInstance = defineComponent({
    ...
    setup: function (props, _a) {
        ...
        return function (_, cache) {
            var _a, _b;
            return createVNode$1('div', { style: { display: ((_b = (_a = props.states) === null || _a === void 0 ? void 0 : _a.visible) !== null && _b !== void 0 ? _b : true) ? 'block' : 'none' } }, [
...
function useState(initValue) {
    var state = ref$1(initValue);
    var getState = (function (isRef) { return (isRef ? state : unref$1(state)); });
                                            ...
                                            createBlock(Fragment$1, null, [
                                                currentOptions().length
                                                    ? createVNode$1('div', _hoisted_attrs_1, [
                                                        (openBlock(),
                                                            createBlock(Fragment$1, null, currentOptions().map(function (option) {
...
var TeleForm = defineComponent({
    ...
    setup: function (props, _a) {
        ...
        // 当前展示的表单项
        var currentFormItems = reactive$1(R.defaultTo([], cache.getFormCacheIO.unsafePerformIO()));
        var getCurrentFormItems = R.always(currentFormItems);
        var oldCurrentFormItems = __spreadArray([], __read(currentFormItems));
        watch$1(getCurrentFormItems, function () {
        ...
        var formConfig = reactive$1([]);
        // 允许的表单项{id,name}[]
        var searchableOptionList = reactive$1([]);
        ...
        watch$1(getCurrentFormItems, R.compose(unsafeUpdateConfig, function (val) {
        ...
        var states = reactive$1(cache.getVisibleCacheIO.map(R.compose(R.objOf('visible'), truthy)).unsafePerformIO());
        var toggleVisibleStates = function () { return (states.visible = !states.visible); };
        watch$1(function () { return states.visible; }, cache.setVisibleCacheIO.unsafePerformIO.bind(cache.setVisibleCacheIO));
        ...
        var _hoisted_node_1 = createVNode$1('div', _hoisted_attrs_2);
        var renderForm = function () {
            return createVNode$1('div', { "class": 'cx-table_tele_form' }, [
                createVNode$1('div', _hoisted_attrs_1, [
                ...
                createVNode$1('div', _hoisted_attrs_3, [
                    withDirectives(createVNode$1(TeleFormInstance, { states: states, form: form, items: formConfig, onChange: fetchAllData, onClose: onClose }, { add: renderDynamicFormAdd }, PATCH_FLAG.FULL_PROPS), [[_hoisted_direction !== null && _hoisted_direction !== void 0 ? _hoisted_direction : {}, formLoading()]])
                ])
            ]);
        };
        // unsafeClearDom::void->string
        var unsafeClearEle = R.compose(map$1(unsafeSet(R.__, 'innerHTML', '')), Maybe.of);
        // renderVNodeToDom::HTMLElement->void
        var renderVNodeToDom = R.compose(R.converge(render$5, [renderForm, R.identity]), R.tap(unsafeClearEle), R.tap(unsafeDeleteProperty(R.__, '_vnode')));
        var unsafeWarn = function () {
            return cxTableWarn("can't find container element by selector", rootProp.formTeleport);
        };
        // 组件更新IO
        var updateComponentIO = IO.of(queryDom).map(R.ifElse(R.isNil, R.compose(unsafeWarn, unsafeClearEle, container), R.compose(map$1(renderVNodeToDom), Maybe.of, setContainer)));
        watch$1(function () { return props.dynamicColumn; }, function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, nextTick$1()];
                    case 1:
        ...
        watch$1(function () { return rootProp.dynamic; }, function () {
            setFormLoading(true);
            cache.getVisibleCacheIO
                .map(R.compose(unsafeSet(states, 'visible'), truthy))
                .unsafePerformIO();
        });
        watch$1([function () { var _a; return (_a = rootProp.pagination) === null || _a === void 0 ? void 0 : _a.currentPage; }, function () { var _a; return (_a = rootProp.pagination) === null || _a === void 0 ? void 0 : _a.pageCapacity; }], fetchTableData);
...
var script$3 = defineComponent({
    ...
    setup: function (props, _a) {
        ...
        var refOneEllipsis = ref$1();
        var refContent = ref$1();
        var tipVisible = ref$1(false);
        var paddingRight = ref$1('0');
        ...
        var popperConfig = reactive$1({
            text: props.content,
            visible: tipVisible.value,
            controlType: 'mouse',
            placement: props.placement
        });
        watch$1([function () { return props.content; }, function () { return props.placement; }, tipVisible], function (_a) {
...
var cacheListDialog = defineComponent({
    ...
    setup: function (_, _a) {
        ...
        var tableConfig = reactive$1({ items: [] });
        ...
        watch$1(function () { return activeItem(); }, R.compose(R.ifElse(arrNotEmpty, initAndSetConfig, R.converge(initAndSetConfig, [getGlobalConfig])), R.prop('table'), R.defaultTo({})));
        // ------------------------------ api ------------------------------
        ...
        var getOrderList = R.nAry(0, orderList);
        ...
        var fetchHandleIO = sendRequestIO.map(map$1(R.andThen(map$1(R.compose(R.tap(R.compose(map$1(setGlobalConfig), maybePropTable)), R.tap(R.compose(map$1(R.compose(setHasDone, isHasDone)), maybePropTotal)), R.tap(R.compose(map$1(pushInOrderList), maybePropRows)), R.pick(['total', 'rows', 'table']))))));
        ...
        var scrollFetchRequest = R.compose(map$1(R.andThen(setDefaultActive)), fetchData);
        ...
        var removeFetch = R.ifElse(getLock, R.identity, R.compose(R.compose(map$1(R.andThen(R.converge(setLock, [R.F]))), scrollFetchRequest), setLock, R.T));
        // ------------------------------ 删除 ------------------------------
        ...
        // 使用数组绑定会出现异常触发的情况
        watch$1(function () { return rootProp.dynamic.businessType; }, setBusOff);
        watch$1(function () { return rootProp.dynamic.modelType; }, setBusOff);
        // ------------------------------ 提交 ------------------------------
        ...
        // ------------------------------ 组合exist与submit ------------------------------
        var onOk = R.compose(map$1(R.andThen(R.ifElse(dataIsFalsy, continueEdit, notExistToast))), R.converge(orderIsExist, [
            R.converge(R.zipObj, [
                R.always(['id', 'api']),
                R.converge(R.pair, [
        ...
        var renderListItem = R.curryN(2, function (item, currentItem) {
            ...
            return createVNode$1('li', {
                ...
                createVNode$1('div', { "class": _hoisted_class_9 }, [
                    ...
                    createVNode$1('i', __assign(__assign({}, _hoisted_attrs_1), { onClick: R.compose(R.converge(removeItem, [R.always(getId(item))]), stopPropagation, preventDefault) }))
                ])
            ], PATCH_FLAG.FULL_PROPS);
        });
        ...
        var renderOrderInfoItem = function (state, item) {
            var render = function (content) {
                var _a;
                return [
                    createVNode$1('label', null, ((_a = state["label_" + currentType()]) !== null && _a !== void 0 ? _a : state.label) + ":"),
                    createVNode$1('div', { "class": _hoisted_class_4 }, content !== null && content !== void 0 ? content : state.defaultValue, PATCH_FLAG.TEXT)
                ];
            };
        ...
        var renderOrderTable = function (config, dataList) {
            return createVNode$1(_CX_TABLE, __assign(__assign({ dynamicInject: dynamicInject }, R.pick(['ignoreControl'], rootProp)), { tableConfig: config, disabled: true, keyboard: false, height: 427, "class": 'cx_m_16', tableData: dataList, configurable: false }), __assign(__assign({}, rootSlots), { renderWithText: function (_a) {
                    var _b, _c, _d, _e;
                    ...
                    return [createVNode$1(script$3, { content: content }, null, PATCH_FLAG.PROPS, ['content'])];
                        ...
                        "default": function () {
                            return [
                                ...
                                createVNode$1('section', { "class": _hoisted_class_6 }, [
                                    ...
                                    // 搜索项
                                    createVNode$1(_CX_FORM, { form: form, items: items, onChange: conditionChangeFetch, style: 'margin-bottom:-18px' }, null, PATCH_FLAG.PROPS, R.of('form'))
                                ]),
                                // 内容区
...
var renderInnerBtn = function (_a) {
    ...
    return createVNode$1(_CX_BTN, __assign(__assign({}, $attrs), { level: (_b = $attrs.level) !== null && _b !== void 0 ? _b : 2, loading: (_c = $attrs.loadingState) === null || _c === void 0 ? void 0 : _c.loading, disabled: (_d = $attrs.disabledState) === null || _d === void 0 ? void 0 : _d.disabled }), $slots, PATCH_FLAG.FULL_PROPS);
};
...
var TeleportBtn = defineComponent({
    ...
    setup: function (props, _a) {
        ...
        var loadingState = reactive$1({ loading: false });
        var setLoadingStates = unsafeSet(loadingState, 'loading');
        var renderBtn = function () {
            return createVNode$1(innerBtn, __assign(__assign({}, attrs), { disabledState: props.disabledState, loadingState: loadingState, onClick: onClick }), slots, PATCH_FLAG.FULL_PROPS);
        };
        // renderVNodeToDom::HTMLElement->void
        var renderVNodeToDom = R.compose(R.converge(render$5, [renderBtn, R.identity]), R.tap(unsafeClearEle), R.tap(unsafeDeleteProperty(R.__, '_vnode')));
        // 组件更新IO
        var updateComponentIO = IO.of(queryDom).map(R.ifElse(R.isNil, R.compose(unsafeWarn, unsafeClearEle, container), R.compose(map$1(renderVNodeToDom), Maybe.of, setContainer)));
        watch$1(function () { return props.dynamicColumn; }, function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
...
var CacheListBtn = defineComponent({
    ...
    setup: function (props) {
        ...
        var setCacheIO = dialogRefIO.map(R.compose(map$1(R.compose(R.when(R.is(Function), R.call), R.prop('openDialog'))), Maybe.of));
...
var SetCacheBtn = defineComponent({
    ...
    setup: function (props) {
        ...
        var disabledState = reactive$1(R.objOf('disabled', false));
        ...
        var setCache = R.compose(R.andThen(function () { return afterSetCacheIO.map(map$1(R.call)).unsafePerformIO(rootProp); }), R.andThen(function () { return bus.emit('removeCacheItem'); }), R.andThen(R.compose(setTimer, R.converge(setDisabledTime, [R.always(10)]))), R.andThen(handleResult), R.andThen(sendRequest), getParams);
        return function () {
...
var useDynamicConfigDialog = function () {
    ...
    var listMap = reactive$1(getDefaultData());
...
var script = defineComponent({
    ...
    setup: function (props, _a) {
        ...
        var tableWrapper = ref$1(null);
        var tableVisible = ref$1(!props.lazy);
        onMounted$1(function () {
            if (!tableWrapper.value)
                return;
        ...
        var renderContent = function (fixed) {
            return createVNode$1(CxTableContent, { tableData: tableDataVisitor.sortedData, fixed: fixed }, null, PATCH_FLAG.PROPS, ['tableData']);
        };
        ...
        var renderTeleBtn = function (comp) {
            return createVNode$1(comp, { dynamicColumn: dynamicColumn.value, tableDataVisitor: tableDataVisitor }, null, PATCH_FLAG.PROPS, ['dynamicColumn', 'tableDataVisitor']);
        };
        ...
        return function (_, cache) {
            return createVNode$1('div', { style: cssVariable.value, "class": 'cx-table_container' }, [
                ...
                createVNode$1('div', { tid: tid, "class": _hoisted_1_class }, [
