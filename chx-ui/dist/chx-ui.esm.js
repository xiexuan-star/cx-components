...
var useSortable = function ($CxTable, props, radio, selectConfig, visible, emit) {
    var sortableInstance = null;
    var updateInstance = ref(false);
    watch([function () { return $CxTable.flatColumns; }, visible], function () {
        updateInstance.value = (!!$CxTable.flatColumns.find(function (item) { var _a; return (((_a = item.control) === null || _a === void 0 ? void 0 : _a.type) === 'draggable'); })) && visible.value;
    });
    var cancelWatch = null;
    onMounted(function () {
        var container = $CxTable.wrapperEle;
        cancelWatch = watch(updateInstance, function (v) { return __awaiter(void 0, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, nextTick()];
                    case 1:
    ...
    function createInstance(bindEle) {
        destroyInstance();
        if (!bindEle)
            return;
        sortableInstance = Sortable.create(bindEle, {
            ...
            onEnd: function (_a) {
                ...
                if (newIndex === oldIndex)
                    return;
                var old = props.tableData[oldIndex];
                if (!old)
                    return;
                if (newIndex < oldIndex) {
                ...
                var selectItem = selectConfig.selectItem;
                var oldCheck = selectItem[oldIndex];
                if (newIndex < oldIndex) {
...
var useSelectConfig = function (tableDataVisitor, emit) {
    ...
    watchEffect(function () {
        ...
        (_a = tableDataVisitor.sortedData) === null || _a === void 0 ? void 0 : _a.forEach(function (row) {
            var _a;
    ...
    var getSelectRowData = function () {
        return tableDataVisitor.sortedData.filter(function (_, index) {
